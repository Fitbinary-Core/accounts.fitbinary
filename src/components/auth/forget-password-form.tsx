...
import { sendForgetPasswordPin, verifyForgetPasswordPin, resetPassword } from "@/services/auth/auth.service";
...
export default function ForgetPasswordForm() {
    ...
    const resetPasswordMutation = useMutation({
        mutationFn: async () => resetPassword({ email, otp, newPassword: password }),
        onSuccess: (response: any) => {
            ...
            <div className="w-full md:w-[50%] flex flex-col justify-center px-8 md:px-16 lg:px-24 py-12 border-r border-zinc-100">
                <div className="w-full max-w-100 mx-auto">
                    ...
                    {step === 1 && (
                        <>
                            <div className="mb-10">
                                <Link href="/signin" className="inline-flex items-center text-sm font-medium text-zinc-500 hover:text-zinc-900 mb-6 transition-colors">
                            ...
                            <form onSubmit={handleSendPin} className="space-y-6">
                                ...
                                >
                                    ...
                                    {!sendPinMutation.isPending && <ArrowRight className="size-4 opacity-70 group-hover:translate-x-1 transition-transform" />}
                                </Button>
                            </form>
                        </>
                    )}
                    ...
                    {step === 2 && (
                        <>
                            <div className="mb-10">
                                <button onClick={() => setStep(1)} className="inline-flex items-center text-sm font-medium text-zinc-500 hover:text-zinc-900 mb-6 transition-colors">
                            ...
                            <form onSubmit={handleVerifyOTP} className="space-y-6">
                                ...
                                >
                                    ...
                                    {!verifyPinMutation.isPending && <ArrowRight className="size-4 opacity-70 group-hover:translate-x-1 transition-transform" />}
                                </Button>
            ...
            <div className="hidden md:flex flex-1 bg-zinc-950 relative overflow-hidden flex-col justify-between p-6 md:p-12">
                ...
                <div className="relative z-10 border-t border-zinc-800 pt-8 mt-16 max-w-lg">
                    <p className="text-lg text-zinc-400 leading-relaxed">
                        "Fitbinary's secure access protocols keep our enterprise data safe while ensuring our team never loses a moment of productivity."
                    </p>
                    <div className="mt-6 flex items-center gap-4">
                        ...
                        <div>
                            ...
                            <div className="text-zinc-500 text-sm">Security Head, Fortis Inc.</div>
                        </div>
                    </div>
                </div>
            </div>
