        ...
        <div className="p-2 md:p-6 flex flex-col md:flex-row gap-8">
          ...
          <div className="w-full md:w-1/3 space-y-4">
            ...
            <button
              ...
              className={`w-full p-4 rounded-md cursor-pointer border-2 transition-all flex items-center justify-between group ${
                provider === "STRIPE"
            ...
            >
              <div className="flex items-center gap-4">
                <div
                  className={`w-12 h-12 rounded-full flex items-center justify-center text-xs font-black transition-colors text-indigo-600`}
                >
                  Stripe
                </div>
            ...
            <button
              ...
              className={`w-full p-4 rounded-md border-2 cursor-pointer transition-all flex items-center justify-between group ${
                provider === "ESEWA"
            ...
            >
              <div className="flex items-center gap-4">
                <div
                  className={`w-12 h-12 rounded-full flex items-center justify-center text-xs font-black transition-colors text-green-600`}
                >
                  eSewa
                </div>
                <div className="text-left">
