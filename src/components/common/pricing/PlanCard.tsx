...
export const PlanCard = ({ plan, billingCycle, onSelect }: PlanCardProps) => {
  ...
  return (
    <div
      className={`flex flex-col bg-white border-2 rounded-2xl transition-all duration-300 relative group min-h-full ${
        isPremium
          ? "border-red-600 space-y-4 md:scale-105 z-10"
    ...
    >
      ...
      <div className="p-8">
        ...
        <Button
          ...
          className={`w-full py-6 rounded-xl font-semibold text-sm transition-all border-2 ${
            isPremium
