                ...
                <div className="mt-4 flex justify-center">
                    <div className="inline-flex border border-gray-200 bg-white p-1 rounded-full shadow-sm">
                        <button
                            ...
                            className={`px-6 py-2.5 text-sm cursor-pointer font-semibold rounded-full transition-all ${billingCycle === "MONTHLY"
                        ...
                        <button
                            ...
                            className={`px-6 py-2.5 text-sm font-semibold cursor-pointer rounded-full transition-all flex items-center gap-2 ${billingCycle === "YEARLY"
                                ? "bg-red-600 text-white shadow-md shadow-red-600/20"
                                : "text-gray-600 hover:text-gray-900 hover:bg-gray-50"
                                }`}
                        >
                            Billing Annually
                            <span
                                className={`px-2 py-0.5 text-[10px] rounded-md uppercase tracking-wider ${billingCycle === "YEARLY"
