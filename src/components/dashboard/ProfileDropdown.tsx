    ...
    return (
        <div className="relative" ref={dropdownRef}>
            <button
                ...
                className="flex items-center justify-center w-10 h-10 rounded-full bg-brand-red text-white font-medium hover:ring-4 hover:ring-red-100 transition-all"
            >
                N
            </button>
            ...
            {isOpen && (
                <div className="absolute right-0 mt-2 w-80 bg-white rounded-2xl shadow-xl border border-gray-200 overflow-hidden z-50 animate-in fade-in zoom-in duration-200">
                    <div className="p-6 text-center border-b border-gray-100">
                        <div className="w-16 h-16 bg-brand-red text-white text-2xl font-bold flex items-center justify-center rounded-full mx-auto mb-3">
                            N
                        </div>
                        <h3 className="text-lg font-semibold text-gray-900">Nabaraj</h3>
                        <p className="text-sm text-gray-500">nabaraj@fitbinary.com</p>
