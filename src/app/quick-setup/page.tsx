    ...
    return (
        <main className="min-h-screen bg-white font-sans text-zinc-900 selection:bg-brand-red/10 selection:text-brand-red">
            ...
            <head>
                ...
                <meta name="description" content="Streamlined onboarding for Fitbinary's enterprise ecosystem. Configure Fitstock, Fitcloud, and your organizational identity in minutes." />
            ...
            <nav className="sticky top-0 z-50 bg-white/80 backdrop-blur-md border-b border-zinc-100 px-6 h-20 flex items-center justify-between">
                <div className="flex items-center gap-4">
                    ...
                    <div className="flex items-center gap-2">
                        ...
                        <span className="font-black tracking-tighter text-xl">FITBINARY</span>
                    </div>
                </div>

                <div className="flex items-center gap-6">
                    <div className="hidden md:flex items-center gap-4 text-[10px] font-bold uppercase tracking-widest text-zinc-400">
                        <span className={cn(currentStep >= 1 ? "text-zinc-900" : "")}>Identity</span>
                        <ArrowRight className="size-3" />
                        <span className={cn(currentStep >= 2 ? "text-zinc-900" : "")}>Ecosystem</span>
                        <ArrowRight className="size-3" />
                        <span className={cn(currentStep >= 3 ? "text-zinc-900" : "")}>Security</span>
                    </div>
            ...
            <div className="max-w-6xl mx-auto px-6 py-12 md:py-20 space-y-16">
                ...
                <div className="max-w-3xl space-y-6">
                    ...
                    <h1 className="text-5xl md:text-7xl font-black text-zinc-900 tracking-tight leading-[0.9]">
                        Initialize your <br />
                        <span className="text-zinc-400 font-extralight italic">Enterprise.</span>
                    </h1>
                    <p className="text-lg text-zinc-500 max-w-xl leading-relaxed">
                        Welcome to the Fitbinary Setup Guide. We've streamlined the complex task of organizational configuration into three distinct milestones.
                    </p>
                </div>
                    ...
                    <div className="lg:col-span-4 space-y-8">
                            ...
                            {steps.map((step) => (
                                ...
                                >
                                    <div className={cn(
                                        ...
                                        currentStep === step.id ? "bg-brand-red" : "bg-zinc-50 group-hover:bg-zinc-100"
                                    )}>
                                        <step.icon className={cn("size-5", currentStep === step.id ? "text-white" : "text-zinc-400")} />
                                    </div>
                                    <div className="space-y-1">
                                        <h3 className={cn("font-bold text-sm", currentStep === step.id ? "text-white" : "text-zinc-900")}>
                                            {step.title}
                                        </h3>
                        ...
                        <div className="bg-zinc-50 rounded-3xl p-8 space-y-6">
                            <div className="space-y-2">
                                <p className="text-[10px] font-black text-zinc-400 uppercase tracking-widest">Setup Status</p>
                                <div className="flex items-baseline gap-2">
                                    <span className="text-4xl font-black">{Math.round((currentStep / 3) * 100)}%</span>
                                    <span className="text-xs font-bold text-zinc-500 uppercase">Deployed</span>
                                </div>
                            </div>
                            ...
                            <div className="flex items-center gap-3 text-zinc-400">
                                ...
                                <p className="text-[10px] font-bold uppercase tracking-wider">Fast-track mode active</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="lg:col-span-8 space-y-8 animate-in fade-in slide-in-from-right-8 duration-700">
                        <div className="bg-white border border-zinc-100 rounded-[40px] p-8 md:p-12 shadow-sm relative overflow-hidden">
                            ...
                            <div className="relative z-10 space-y-12">
                                <div className="flex items-center justify-between">
                                    <div className="space-y-2">
                                        <p className="text-[10px] font-bold text-brand-red uppercase tracking-[0.2em]">Module 0{currentStep}</p>
                                        <h2 className="text-3xl font-black text-zinc-900">{steps[currentStep - 1].title}</h2>
                                    </div>
                                    {(() => {
                                    ...
                                    {steps[currentStep - 1].tasks.map((task, idx) => (
                                        ...
                                        >
                                            <div className="flex items-center gap-4">
                                                ...
                                                <span className="text-sm font-bold text-zinc-600 group-hover/item:text-zinc-900 transition-colors">{task}</span>
                                            </div>
                                ...
                                <div className="pt-8 flex items-center justify-between border-t border-zinc-50">
                                    ...
                                    >
                                        {currentStep === 3 ? "Initialize Workspace" : "Validate Milestone"}
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                            {[
                                ...
                                <div key={i} className="bg-zinc-50 rounded-2xl p-6 flex items-center gap-4">
                                    ...
                                    <div>
                                        <p className="text-[10px] font-black text-zinc-400 uppercase">{stat.label}</p>
            ...
            <footer className="py-20 text-center space-y-4">
                <p className="text-[10px] font-bold text-zinc-500 uppercase tracking-[0.3em]">Built for scale with Fitbinary</p>
