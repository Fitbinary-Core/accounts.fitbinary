...
import { Save, MoveLeft, Trash2 } from "lucide-react";
        ...
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-4">
            ...
            <div>
              ...
              <p className="text-zinc-500">Updating ID: {id}</p>
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div className="space-y-2">
              ...
              <select className="w-full h-12 px-4 bg-zinc-50 border border-zinc-100 rounded-xl text-sm focus:ring-2 focus:ring-brand-red/20">
                <option selected>Main Company</option>
