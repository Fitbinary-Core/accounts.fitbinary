            ...
            <div className="w-full p-8 mx-auto space-y-12 animate-in fade-in slide-in-from-bottom-4 duration-1000">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                    <div className="md:col-span-2 space-y-6">
                        ...
                        <p className="text-zinc-500 leading-relaxed italic">
                            "At Fitbinary, we don't just secure your business; we protect your legacy.
                            Our commitment to data sovereignty ensures that business owners remain the sole administrators
                            of their operational intelligence."
                        </p>
                        <div className="space-y-4 text-sm text-zinc-600 leading-relaxed">
                            <p>
                                Fitbinary.com operates as a centralized infrastructure provider for modern enterprise solutions.
                                Whether you are utilizing <strong>Fitstock</strong> for inventory or <strong>Fitcloud</strong> for facility management,
                                your data is isolated, encrypted, and remains under your exclusive control.
                            </p>
                        </div>
                    </div>

                    <div className="bg-zinc-50 rounded-2xl p-6 border border-zinc-100 space-y-4">
                        <h3 className="text-xs font-bold text-zinc-400 uppercase tracking-widest">At a Glance</h3>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-8 pt-8 border-t border-zinc-100">
                    ...
                    <div className="space-y-6 group">
                        ...
                        <h3 className="text-xl font-bold text-zinc-900">Fitstock: Inventory Intelligence</h3>
                        <p className="text-sm text-zinc-500 leading-relaxed">
                            For supply chain and retail operations, we collect and process SKU data, transaction history, and
                            vendor information. This data is used solely to provide analytics, predict stockouts, and manage
                            your logistics ecosystem within the Access Panel.
                        </p>
                        <div className="p-4 bg-zinc-50 rounded-xl">
                            <p className="text-[10px] font-bold text-zinc-400 uppercase mb-2">Key Data Handled</p>
                            <ul className="grid grid-cols-2 gap-2">
                                {["Inventory Levels", "Sale Records", "Supplier Data", "Cost Tracking"].map((t, i) => (
                                    <li key={i} className="text-[10px] text-zinc-600 font-medium flex items-center gap-1">
                    ...
                    <div className="space-y-6 group">
                        ...
                        <h3 className="text-xl font-bold text-zinc-900">Fitcloud: Facility Ecosystem</h3>
                        <p className="text-sm text-zinc-500 leading-relaxed">
                            Managing health and fitness centers requires handling sensitive member information. Fitcloud
                            processes attendance records, membership subscriptions, and trainer assignments. We implement
                            additional layers of privacy for member PII (Personally Identifiable Information).
                        </p>
                        <div className="p-4 bg-zinc-50 rounded-xl">
                            <p className="text-[10px] font-bold text-zinc-400 uppercase mb-2">Key Data Handled</p>
                            <ul className="grid grid-cols-2 gap-2">
                                {["Member Profiles", "Check-in Logs", "Subscription Plans", "Trainer KPIs"].map((t, i) => (
                                    <li key={i} className="text-[10px] text-zinc-600 font-medium flex items-center gap-1">
                                        <div className="size-1 bg-zinc-300 rounded-full" /> {t}
                                    </li>
                                ))}
                ...
                <div className="bg-zinc-900 rounded-3xl p-8 text-white relative overflow-hidden">
                    ...
                    <div className="relative z-10 space-y-6">
                        ...
                        <p className="text-zinc-400 text-sm max-w-2xl leading-relaxed">
                            This Access Panel is your central command for privacy. You have the right to request a full
                ...
                <div className="pt-8 border-t border-zinc-100 flex flex-col md:flex-row items-center justify-between gap-6">
                    <div className="flex items-center gap-3 text-zinc-400">
                        ...
                        <p className="text-xs font-medium">Need more detailed compliance documents?</p>
                    </div>
